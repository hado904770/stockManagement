...
$(document).ready(function() {
  ...
  function insertProduct() {
    $("#add_product").on(`click`, `button[id='add_btn']`, function(e) {
      ...
      $.ajax({
        type: `POST`,
        url: DOMAIN_API + DOMAIN_PRODUCT + REQUEST_SAVE,
        contentType: `application/json`,
        dataType: `json`,
        data: JSON.stringify({
          code: code,
  ...
  function blockAddProduct() {
    $(`button[data-target='#add_product']`).click(function(e) {
      ...
      $.ajax({
        type: `POST`,
        url: DOMAIN_API + DOMAIN_PRODUCT + REQUEST_GET_CODE,
        contentType: `application/json`,
        dataType: `json`,
        data: JSON.stringify({
          // No data
  ...
  function blockEditProduct() {
    $(`#products`).delegate(
      `button[data-target='#edit_product']`,
      `click`,
      function(e) {
  ...
  function blockDeleteProduct() {
    $(`#products`).delegate(
      `button[data-target='#delete_product']`,
      `click`,
      function(e) {
        let id = $(this)
          .closest(`tbody tr`)
  ...
  function deleteProduct() {
    $("#delete_product").on(`click`, `button[id='delete_btn']`, function(e) {
      ...
      $.ajax({
        type: `POST`,
        url: DOMAIN_API + DOMAIN_PRODUCT + REQUEST_DELETE,
        contentType: `application/json`,
        dataType: `json`,
        data: JSON.stringify({
          id: id
